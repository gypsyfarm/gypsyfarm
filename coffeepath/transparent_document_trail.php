...
$step  = $_REQUEST['step'];
if (isset($rst_id)) {
   echo "src='bottom_what.php?rst_id=$rst_id&step=$step' title='Bottom What'>";
}
elseif (isset($coop_id)) {
   echo "src='bottom_what.php?coop_id=$coop_id&step=$step' title='Bottom What'>";
}
else {
   echo "src='bottom_what.php?coop_id=20' title='Bottom What'>";	
}
?>
</frameset>
<noframes>
