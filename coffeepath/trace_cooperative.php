...
<center>
<form name=frmMain method=post action='trace_cooperative.php?action=list'>
<table width=100%>
<tr>
<td align=left>
<div class="corners">
...
if ($action == 'list') {
	...
	echo '<a href="lot_search.php?coop_id=1">Fecafeb </a><br>';
	echo '<a href="lot_search.php?coop_id=2">Fondo Paez </a><br>';
	echo '<a href="lot_search.php?coop_id=3">Maya Vinic </a><br>';

 
}
else {
	
	echo '<INPUT TYPE="SUBMIT" id="trace2" name="trace2" VALUE="Trace Lot # ';
	echo "\n";
        echo 'from a Farming Cooperative" class="ccbtn"> ';
        echo '<br>';
}
