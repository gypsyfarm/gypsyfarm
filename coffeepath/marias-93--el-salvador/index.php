...
elseif ($btn1 != "") {
	#header("Location: http://www.coffeepath.org/transparent_document_trail.php?coop_id=$coop_id" );
...
<BODY BGCOLOR="#000000" text="ececec" link="F76B08" alink="ffffff" vlink="ececec" link="F76B08" alink="ffffff" vlink="ececec" >


<center>
<form name=frmMain method=post action='index.php?coop_id=19'>
