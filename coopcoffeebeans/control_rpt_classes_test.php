...
class myControlReport {
  ...
  function OnWaterTable(){
     ...
     for ($i=0; $i <$num_results;  $i++) {
       ...
       if ($month == 1) {
       	...
       	$this->readme .= "<br> Ok onWay01 being set to $this->OnWay01 ";
       }
 ...
 # average last 12 Months.
    ...
    function set_next_year_commits($year_range,$item_code)   {
     ...
     #   $content = "PYT";
       ...
       $queryP = "select item_code,
         ...
         $this->readme .= "<br>QuerPy =  $queryP <br> ";    
         
         
        $this->readme .= "<br>OnWay01 = $this->OnWay01 ";
        $this->readme .= "<br>OnWay02 = $this->OnWay02 ";
        $this->readme .= "<br>OnWay03 = $this->OnWay03 ";
        $this->readme .= "<br>OnWay04 = $this->OnWay04 ";
        $this->readme .= "<br>OnWay05 = $this->OnWay05 ";
        $this->readme .= "<br>OnWay06 = $this->OnWay06 ";
        $this->readme .= "<br>OnWay07 = $this->OnWay07 ";
        $this->readme .= "<br>OnWay08 = $this->OnWay08 ";
        $this->readme .= "<br>OnWay09 = $this->OnWay09 ";
        $this->readme .= "<br>OnWay10 = $this->OnWay10 ";
        $this->readme .= "<br>OnWay11 = $this->OnWay11 ";
        $this->readme .= "<br>OnWay12 = $this->OnWay12 ";
   ...
   #    echo $this->CreateCell($content,$class,1);       
       ...
       $this->readme .= " <br> adding $month01_total + $this->OnWay01 ";
       $content = $month01_total;
       echo $this->CreateCell($content,$class,1);
       if ($this->current_month == 5) {
          $class = 'heading1';
       ...
       $OnwayValue = $this->OnWay01; 
       
       if ($this->current_month == 1) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month01_total  + $OnwayValue;
       echo  $this->CreateCell($content,$class,1);
       
       
       $OnwayValue = $this->OnWay02;
       if ($this->current_month == 2) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
        $content =  $this->prev_value - $month02_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay03;
       if ($this->current_month == 3) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
        $content =  $this->prev_value - $month03_total   + $OnwayValue; 
      echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay04;
       if ($this->current_month == 4) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month04_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay05;
       if ($this->current_month == 5) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
        $content =  $this->prev_value - $month05_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay06;
       if ($this->current_month == 6) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month06_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay07;
       if ($this->current_month == 7) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month07_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay08;
       if ($this->current_month == 8) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month08_total  + $OnwayValue;
       echo  $this->CreateCell($content,$class,1);
       
       
       $OnwayValue = $this->OnWay09;
       if ($this->current_month == 9) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month09_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay10;
       if ($this->current_month == 10) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month10_total  + $OnwayValue;  
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay11;
       if ($this->current_month == 11) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month11_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
       
       $OnwayValue = $this->OnWay12;
       if ($this->current_month == 12) {
          $class = 'heading1';
          $OnwayValue = 0;
       }
       $content =  $this->prev_value - $month12_total  + $OnwayValue; 
       echo  $this->CreateCell($content,$class,1);
