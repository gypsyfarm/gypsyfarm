...
<html>
<head>
  <title>Review Order Processing Page 2:</title>
...
-->
<?PHP
 echo "<form name='frmMain' action=orderorder2.php?order_id=".$order_id." method=post>";
...
<font size=3><a href="orderorder1.php">Reprocess more  Orders</a></font><br>
<font size=3><a href="../logout.php">Log out</a></font><br>
</td> 
 
 <td colspan=2 align=center>
 <h2>
Cooperative Coffee reset order Page
...
# connect to database
  ...
  if ($subbtn == "ReProcess") {
   mysql_select_db($tbl_order_header);
    ...
    echo "<font color=red><b> Order has been set to be reprossed by $valid_user </b></font> ";
...
<td>
<INPUT name=subbtn TYPE="SUBMIT" value="ReProcess">
</td>
</tr>
