...
// check session variable
  ...
  header("Location: http://www.coopcoffeesbeans.com/badlogin.php");
	...
	#echo'<img SRC="../cclogo.jpeg" BORDER=0 height=122 width=133 align=LEFT>';
       ...
       echo '<form enctype="multipart/form-data" method=POST action="cupping_rpt_delivered.php"  method="post">';
    ...
    echo ' <input type="submit" value="Upload Delivery Cupping Rpt." /> (File name: LOT + Item nbr example GUL101.pdf or also use for pricesheet.pdf (current pricesheet)<br>';
