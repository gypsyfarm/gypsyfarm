...
//********Present the Menus*********************************************
    ...
    if ($user_type == 1) {
	   ...
	   echo '<font face="Verdana" size="1">*<a href="../../Contact_Search/contact_start.php">Contact Database</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../order_processing.php">Process Orders</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../alt_cooporder.php">Enter Orders for Customers</a></font><br>';
         #  echo '<hr>';
	 #  echo '<font face="Verdana" size="1">*<a href="../products/index.html">Lot Maint Org.</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../product_start.php">Lot Maint </a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../alt_pwandid.php">Reset Password for<br>&nbsp;&nbsp; Customers</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../contacts/index.html">Customer Maint.</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../commit_admin.php">Commitment Maint</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="index.php">Reports</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../../Bank/bankreview1.php">Review Approved<br>&nbsp;&nbsp; Orders</a></font><br>';
 	   ...
 	   echo '<font face="Verdana" size="1">*<a href="../../warehouse/whreview1.php">Review Shipped<br>&nbsp;&nbsp; Orders</a></font><br>';	
           echo '<hr>';
 	   echo '<font face="Verdana" size="1">*<a href="..//orderorder1.php">Re-Process Order<br></a></font><br>';	
           echo '<hr>';
	   ...
	   echo '<font face="Verdana" size="1">*<a href="../../Bank/bankreview1.php">Review Approved Orders</a></font><br>';
           ...
           echo '<hr>';
           echo '<font face="Verdana" size="1">*<a href="customer_sales.php">Sales by Customer Report</a></font><br>';
           echo '<hr>';
  	   echo '<font face="Verdana" size="1">*<a href="sales_vs_commit.php">Sales vs. Commitments</a></font><br>';
            echo '<hr>';
   	   echo '<font face="Verdana" size="1">*<a href="product_summary.php">Inventory Report Product Summary by Warehouse</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../../Customer/password.php">Change Password</a></font><br>';
            echo '<hr>';
     	   echo '<font face="Verdana" size="1">*<a href="../../logout.php">Log out</a></font><br>';
...
if (!isset($_SESSION['contact_id']))  {  
        ...
        echo '<tr>';
          echo '<td width="100%" bordercolor="#228B22" bgcolor="#FFFFFF">';
            echo '<form name="login" method=post action="index.php">';
            echo 'xxxLogin ID:<br><input type="text" name="userid" size="20" style="font-family: Verdana; font-size: 10px; color: #228B22; background-color: #FFFF44; border: 1 solid #228B22" value="User Name">';
            echo '<br> Password:<br>';
