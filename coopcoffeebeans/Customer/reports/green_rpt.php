...
function uploadcode(){ 
    ...
    echo ' <input type="submit" value="Upload PreShip Cupping Rpt" />';
...
echo '&nbsp;&nbsp;(Uses Shipped Date)<span class="noprint"><input type="SUBMIT" name="ACTION" value="Refresh Report"></span>';
echo '</td><td align="center">';
...
$query = "SELECT id.item_code,   ci.lot_ship, id.weight as bag_lbs,
          ...
          AND ci.green_cb = 1
           ...
           and ci.warehouse in ('N','T','S','V','E','J','H')
	      ORDER by ci.warehouse, ci.item_code ";
...
for ($i=0; $i <$num_results;  $i++) {
   ...
   if ($row['warehouse'] != $prev_warehouse) {
      ...
      echo '<td colspan=13><font size=2 color=blue>Warehouse : '.$warehouse_text.'</font></td>';
      echo '</tr>';   	
