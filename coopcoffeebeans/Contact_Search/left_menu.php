...
if (isset($_SESSION['contact_id']))  {
  ...
  #  echo "<br>user type is $user_type <br>";
//********Present the Menus*********************************************
    if ($user_type == 1) {
	   ...
	   <a href='#' onclick='javascript:subForm("../index.php");'>Back to Main Menu</a>
           ...
           <hr>	   
           <font face="Verdana" size="1">*
	   <a href='#' onclick='javascript:subForm("contact_start.php");'>Contact Database</a>
	   </font><br>
	   <hr>
	   <font face="Verdana" size="1">*
	   <a href='#' onclick='javascript:subForm("add_contact.php");'>Add New Contact</a>
	   </font><br>
	   <hr>
	   <font face="Verdana" size="1">*
	   <a href='#' onclick='javascript:subForm("contact_note_rpt.php");'>Note Report</a>
	   </font><br>
	   <hr>	   	   
	   ...
	   echo '<font face="Verdana" size="1">*<a href="../Bank/bankreview1.php">Review Approved Orders</a></font><br>';
           ...
           echo '<hr>';
           echo '<font face="Verdana" size="1">*<a href="../Bill/reports/customer_sales.php">Sales by Customer Report</a></font><br>';
            echo '<hr>';
   	   echo '<font face="Verdana" size="1">*<a href="../Bill/reports/sales_vs_commit.php">Sales vs. Commitments</a></font><br>';
            echo '<hr>';
   	   echo '<font face="Verdana" size="1">*<a href="../Bill/reports/product_summary.php">Inventory Report Product Summary by Warehouse</a></font><br>';
           echo '<hr>';
	   echo '<font face="Verdana" size="1">*<a href="../Customer/password.php">Change Password</a></font><br>';
           echo '<hr>';
     	   echo '<font face="Verdana" size="1">*<a href="../logout.php">Log out</a></font><br>';
